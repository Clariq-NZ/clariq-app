-- 0050: the register shows where a container landed. sighted_location_id
-- now falls back to the location given at RECEIVED when no audit sighting
-- since dispatch exists. Column set unchanged.
