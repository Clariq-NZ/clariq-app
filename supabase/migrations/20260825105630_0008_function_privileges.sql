...
-- Internal helpers and trigger functions stay owner-only (triggers and
-- security-definer callers do not need grants). App-facing RPCs:
...
-- Default for future functions: no automatic PUBLIC execute
